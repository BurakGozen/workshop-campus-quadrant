...
export default function Home() {
  return (
    <div className="w-screen h-screen relative z-0 grid place-items-center">
      ...
      <span className="flex flex-col justify-center items-center gap-10">
        <Text type="h1" color="dark" shade={400} className="text-5xl font-medium">
          Welkom, op de workshop van NewCode
        </Text>
